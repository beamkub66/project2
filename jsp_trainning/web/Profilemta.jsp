...
<html>
    ...
    <body>
        ...
        <%
            ...
            {
                response.sendRedirect("frm_login_mta.jsp");
            }
            ...
            try {
                ...
                String sql = "SELECT * FROM profes_mta WHERE id_teach = '" + strid_teach.toString() + "' ";
                ...
                <tbody>
                    ...
                    <tr> <td align="center">
                            <a class="btn btn-blue" onclick="return
                               ...
                               " href="e_mta.jsp?id_teach=<%=rs.getString("id_teach")%>">แก้ไข</a></tr>
                </tbody>
            </table>
            <br>	</div>
            <%} %>
