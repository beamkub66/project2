...
<html>   
    ...
    <%        String sql = "select * from profes_tm where id_teach=" + request.getParameter("id_teach");
    ...
    <body>    
        ...
        <div class="content"  >
            ...
            <form action="manage/up_e_tm.jsp" method="post" autocomplete="off">        
                <div class="group-input container" >           
                    <div style="width: 90%;">    
                        ...
                        <div align="center"> 
                           ...
                           <button  class="btn btn-red" type="Profiletm.jsp">ยกเลิก</button>         
                        </div>
                    </div>         
                </div>   
