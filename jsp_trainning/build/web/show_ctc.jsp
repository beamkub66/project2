...
<html>  
    ...
    <body> 
        <div class="content container">    
            <h1 align="center"><font color="#0000FF ">คณาจารย์ สาขาเทคโนโลยีคอมพิวเตอร์และการสื่อสาร</font></h1>    
            <table border="1" align="center" width="1230px" class="table ta">   
                ...
                <%                    String sql = "select * from profes_ctc";
                ...
                <tr align="left">     
                    ...
                    <td align="center">
                        <a class="btn btn-blue" onclick="return 
                           ...
                           " href="edit_ctc.jsp?id_teach=<%=rs.getString("id_teach")%>">แก้ไข</a>
                         <a class="btn btn-red" onclick="return confirm('คุณต้องการลบใช่ไหม')" 
                            href="manage/delete_ctc.jsp?id_teach=<%=rs.getString("id_teach")%>">ลบ</a>
                    </td>
